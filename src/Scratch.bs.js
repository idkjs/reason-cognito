...
var auth = Cognito.Config.make("us-east-2_pTFKTGtS3", "3vjshpa4lgf92nfisjrg9os21a", /* UsEast2 */1, undefined, undefined);
...
Future.tapError(Future.tapOk(Cognito.changePassword(auth, accessToken, "Password12345@", "Password12345@!", undefined), (function (param) {
            console.log("Success!!!!");
